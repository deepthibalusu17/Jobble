                ...
                <div className="row">
                  <div className="col-md-6 col-12">
                    <div className="form-group mt-2">
                      <label htmlFor="euCitizen">Indian Citizen</label>
                  ...
                  <div className="col-md-6 col-12">
                    <div className="form-group">
                      <label className="form-label" htmlFor="minSalary"> Minimum expected salary(Rupees)</label>
